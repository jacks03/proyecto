...
const FormRegister = () => {
    ...
    //recordemos que evente es solo un nombre este pede ser cambiada por ejemplo por e
    const handleInputName = (e) => {
        //que debemos hacer para poder darle el valor nombre?
        //recodemos que el valor va dentro de los ()
      ...
      <div>
        <form action="">
          ...
          <p>
              ...
              po ende no hace falta pasarrle un parametro */}
            <input 
            type="text" 
