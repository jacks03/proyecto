/**
 * sera nuestro archivo donde vamos almacenar las peticiones
 */
...
//como parametro vamos a recbir la URL que puede ser la que lista o la
//que nos el detalle
//*url sera el parametro que reciba la url hacia donde se hara la peticion
//* url = BASE_URL Significa que si url esta vacio, es decir cuando llamemoos
//*a la funcion no le pasamos por defecto sera BASE_URL
...
export const getDataFromPokemon= async(url= BASE_URL) => {
    try {
        //ahorar debemos ejecutar el fetch para poder traer la informacion
...
//export const storePokemon =()=> {}

//Esto lo hcemos para que exporte mas de una funcion
